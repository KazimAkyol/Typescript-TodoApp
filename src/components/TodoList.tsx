        ...
        >
            ...
            >
                ...
                </Typography>
                {
                    inProgressTodos.length ? (
                        inProgressTodos.map((todo) => <TodoItem key={todo.id} todo={todo} toggleTodo={toggleTodo} deleteTodo={deleteTodo} />)
                    ) : (
            ...
            >
                ...
                {completedTodos.length ? (
                    completedTodos.map((todo) => <TodoItem key={todo.id} todo={todo} toggleTodo={toggleTodo} deleteTodo={deleteTodo} />)
                ) : (
                    <Typography color="error" mt={3}>
                        No Completed Todos!
                    </Typography>
